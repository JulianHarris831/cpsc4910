...
const char *pixFile = "C:/dev/Graphics/IMG/spaceship-32.png";       // bmp, jpg, png, tga supported
...
int main() {
	...
	glBufferSubData(GL_ARRAY_BUFFER, suvs, spts, uvs);              // store uvs after pts in mem
